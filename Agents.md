...
- Backlog stories cite terminology and performance targets from [Project Architecture](project-architecture.md).
...
- Reference dependencies by both human-readable name and mod ID (see [Shared Library: ExtraLib](dependencies/shared-library-extra.md), [Shared Icon Library](ui/shared-icon-library.md), [I18n Everywhere Integration](localization/i18n-integration.md)).
