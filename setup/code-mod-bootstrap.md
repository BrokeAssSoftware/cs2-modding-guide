...
6. Open the solution in Rider, Visual Studio, or VS Code (see [VS Code Build Tasks](build-and-publish.md#vs-code-build-and-attach-tasks)), restore packages, and run `dotnet build` once to verify the pipeline.
